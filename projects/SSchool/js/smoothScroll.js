...
window.addEventListener('load', function() {
  ...
  // element scroll to #oportunities
  document.querySelector('.scrollable-element-to-oportunities').addEventListener('click', function(e) {
    e.preventDefault();
    document.querySelector('#oportunities').scrollIntoView({ behavior: 'smooth' });
  });

  // element scroll to #oportunities2
  document.querySelector('.scrollable-element-to-oportunities2').addEventListener('click', function(e) {
    e.preventDefault();
    document.querySelector('#oportunities').scrollIntoView({ behavior: 'smooth' });
  });

  // element scroll to #shot
  document.querySelector('.scrollable-element-to-shot').addEventListener('click', function(e) {
    e.preventDefault();
    document.querySelector('#shot').scrollIntoView({ behavior: 'smooth' });
  });

  // element scroll to #load
  document.querySelector('.scrollable-element-to-load').addEventListener('click', function(e) {
    e.preventDefault();
    document.querySelector('#load').scrollIntoView({ behavior: 'smooth' });
  });
